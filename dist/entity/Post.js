...
var Post = (_dec = (0, _typeorm.Entity)('posts'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = (0, _typeorm.Column)('varchar'), _dec4 = (0, _typeorm.Column)('text'), _dec5 = (0, _typeorm.CreateDateColumn)(), _dec6 = (0, _typeorm.UpdateDateColumn)(), _dec7 = (0, _typeorm.ManyToOne)(function (type) {
  ...
  return comment.post;
}), _dec9 = (0, _typeorm.Column)('integer'), _dec(_class = (_class2 = /*#__PURE__*/(0, _createClass2["default"])(function Post() {
  ...
  (0, _initializerDefineProperty2["default"])(this, "authorId", _descriptor8, this);
  ...
  writable: true,
  initializer: null
}), _descriptor8 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "authorId", [_dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
